...
export const config = {
    ...
    name: '现实重塑', // 💖 窗口标题栏显示的名称
    description: '系统设置', // 💖 功能描述
    ...
    openMsg: "正在重塑现实参数... ⚙️", // 💖 打开应用时小天使说的话
    content: `
        <h4>选择壁纸</h4>
        <!-- 💖 壁纸网格容器 -->
...
export const APP_NAME = 'Reality Shaper'; // 💖 导出应用名称常量
export const APP_OPEN_MSG = "正在重塑现实参数... ⚙️"; // 💖 导出启动消息常量
