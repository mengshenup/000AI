...
# 🧱 [2025-12-17] 修复: init_memory.py 移动到 staff/ 后路径调整
CURRENT_DIR = Path(__file__).parent.absolute()  # staff/
PROJECT_DIR = CURRENT_DIR.parent  # Web_compute_high/
MEMORY_DIR = PROJECT_DIR / "Memorybank"  # 数据目录在项目根目录下
