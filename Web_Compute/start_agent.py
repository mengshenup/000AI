...
# 将 Agent_Angel_Server 加入 Python 搜索路径
current_dir = os.path.dirname(os.path.abspath(__file__))
workspace_dir = os.path.dirname(current_dir)
agent_server_dir = os.path.join(workspace_dir, "Agent_Angel_Server")
sys.path.append(agent_server_dir)

if __name__ == "__main__":
    print(f"\n🚀 Angel Agent Server (Local Mode) 正在启动...")
    print(f"📂 核心模块路径: {agent_server_dir}")
    
    # 启动 FastAPI 服务
    # 注意: 我们现在从 Web_Compute 目录运行，但代码在 Agent_Angel_Server
