# ==========================================================================
#  📃 文件功能 : 浏览器实例与会话管理器
#  ⚡ 逻辑摘要 : 单例模式管理 Playwright 实例，为每个用户创建隔离的 BrowserContext
#  💡 易懂解释 : 这是 Angel 的车队队长！🚌 负责调度大巴车（浏览器），给每个乘客（用户）安排专座（会话），互不干扰！
#  🔋 未来扩展 : 支持远程浏览器集群，支持更多反爬虫策略
#  📊 当前状态 : 活跃 (更新: 2025-12-03)
#  🧱 browser_manager.py 踩坑记录 :
#     1. [2025-12-03] [已修复] NameError: name 'os' is not defined: 缺少 import os -> 添加导入 (Line 2)
# ==========================================================================
