/* ==========================================================================
   📃 文件功能 : 计费服务 (Billing Service)
   ⚡ 逻辑摘要 : 负责监控网络和 AI 调用费用，通过任务栏胶囊展示实时消费，并提供详情窗口。
   💡 易懂解释 : 这是你的私人会计师！帮你算清楚每一分钱花在哪里，绝不让你当冤大头！💰
   🔋 未来扩展 : 支持导出月度账单，设置消费预警阈值。
...
export const config = {
    ...
    showTaskbarIcon: false,
    isOpen: true, // 默认开启服务
    relatedApps: ['win-billing'] // 💖 关联的子应用 ID (防止被 prune 误删)
};
